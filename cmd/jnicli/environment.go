...
var environmentEnvironmentNewEnvironmentCmd = &cobra.Command{
	Use:   "new-environment",
	Short: "NewEnvironment RPC",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := requestContext(cmd)
		defer cancel()
		client := pb.NewEnvironmentServiceClient(grpcConn)
		req := &pb.NewEnvironmentRequest{}
		resp, err := client.NewEnvironment(ctx, req)
		if err != nil {
			return err
		}
...
func init() {
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentNewEnvironmentCmd)
	environmentEnvironmentGetDataDirectoryCmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentGetDataDirectoryCmd)
	environmentEnvironmentGetDownloadCacheDirectoryCmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentGetDownloadCacheDirectoryCmd)
	environmentEnvironmentGetExternalStorageDirectoryCmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentGetExternalStorageDirectoryCmd)
	environmentEnvironmentGetExternalStoragePublicDirectoryCmd.Flags().Int64("handle", 0, "handle (int64)")
	...
	environmentEnvironmentGetExternalStorageState0Cmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentGetExternalStorageState0Cmd)
	environmentEnvironmentGetExternalStorageState1_1Cmd.Flags().Int64("handle", 0, "handle (int64)")
	...
	environmentEnvironmentGetRootDirectoryCmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentGetRootDirectoryCmd)
	environmentEnvironmentGetStorageDirectoryCmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentGetStorageDirectoryCmd)
	environmentEnvironmentGetStorageStateCmd.Flags().Int64("handle", 0, "handle (int64)")
	...
	environmentEnvironmentIsExternalStorageEmulated0Cmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentIsExternalStorageEmulated0Cmd)
	environmentEnvironmentIsExternalStorageEmulated1_1Cmd.Flags().Int64("handle", 0, "handle (int64)")
	...
	environmentEnvironmentIsExternalStorageLegacy0Cmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentIsExternalStorageLegacy0Cmd)
	environmentEnvironmentIsExternalStorageLegacy1_1Cmd.Flags().Int64("handle", 0, "handle (int64)")
	...
	environmentEnvironmentIsExternalStorageManager0Cmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentIsExternalStorageManager0Cmd)
	environmentEnvironmentIsExternalStorageManager1_1Cmd.Flags().Int64("handle", 0, "handle (int64)")
	...
	environmentEnvironmentIsExternalStorageRemovable0Cmd.Flags().Int64("handle", 0, "handle (int64)")
	environmentEnvironmentCmd.AddCommand(environmentEnvironmentIsExternalStorageRemovable0Cmd)
	environmentEnvironmentIsExternalStorageRemovable1_1Cmd.Flags().Int64("handle", 0, "handle (int64)")
