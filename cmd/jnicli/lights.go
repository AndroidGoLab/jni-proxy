...
var lightsRequestBuilderAddLightCmd = &cobra.Command{
	Use:   "add-light",
	Short: "AddLight RPC",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := requestContext(cmd)
...
var lightsRequestBuilderBuildCmd = &cobra.Command{
	Use:   "build",
	Short: "Build RPC",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := requestContext(cmd)
...
var lightsRequestBuilderClearLightCmd = &cobra.Command{
	Use:   "clear-light",
...
func init() {
	...
	lightsRequestBuilderCmd.AddCommand(lightsRequestBuilderBuildCmd)
	lightsRequestBuilderClearLightCmd.Flags().Int64("arg0", 0, "arg0 (int64)")
	lightsRequestBuilderCmd.AddCommand(lightsRequestBuilderClearLightCmd)
	lightsCmd.AddCommand(lightsRequestBuilderCmd)
