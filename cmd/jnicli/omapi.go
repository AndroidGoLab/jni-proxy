...
func init() {
	...
	omapiSEServiceCmd.AddCommand(omapiSEServiceNewSEServiceCmd)
	omapiSEServiceGetReadersCmd.Flags().Int64("handle", 0, "handle (int64)")
	omapiSEServiceCmd.AddCommand(omapiSEServiceGetReadersCmd)
	omapiSEServiceGetUiccReaderCmd.Flags().Int64("handle", 0, "handle (int64)")
	omapiSEServiceGetUiccReaderCmd.Flags().Int32("arg0", 0, "arg0 (int32)")
	omapiSEServiceCmd.AddCommand(omapiSEServiceGetUiccReaderCmd)
	omapiSEServiceGetVersionCmd.Flags().Int64("handle", 0, "handle (int64)")
	omapiSEServiceCmd.AddCommand(omapiSEServiceGetVersionCmd)
	omapiSEServiceIsConnectedCmd.Flags().Int64("handle", 0, "handle (int64)")
	omapiSEServiceCmd.AddCommand(omapiSEServiceIsConnectedCmd)
	omapiSEServiceShutdownCmd.Flags().Int64("handle", 0, "handle (int64)")
