...
const file_proto_bluetooth_le_bluetooth_le_proto_rawDesc = "" +
	...
	"\x1aStopAdvertisingSetResponse2\xb4\x04\n" +
	...
	"\vStopScan1_1\x12 .bluetooth_le.StopScan1_1Request\x1a!.bluetooth_le.StopScan1_1Response2\xff\v\n" +
	...
	"\rWriteToParcel\x12\".bluetooth_le.WriteToParcelRequest\x1a#.bluetooth_le.WriteToParcelResponse2\x9d\x05\n" +
	...
	"\x12StopAdvertisingSet\x12'.bluetooth_le.StopAdvertisingSetRequest\x1a(.bluetooth_le.StopAdvertisingSetResponseB6Z4github.com/AndroidGoLab/jni-proxy/proto/bluetooth_leb\x06proto3"
...
var file_proto_bluetooth_le_bluetooth_le_proto_goTypes = []any{
	...
	(*DescribeContentsRequest)(nil),                // 12: bluetooth_le.DescribeContentsRequest
	(*DescribeContentsResponse)(nil),               // 13: bluetooth_le.DescribeContentsResponse
	(*EqualsRequest)(nil),                          // 14: bluetooth_le.EqualsRequest
	(*EqualsResponse)(nil),                         // 15: bluetooth_le.EqualsResponse
	(*GetAdvertisingSidRequest)(nil),               // 16: bluetooth_le.GetAdvertisingSidRequest
	(*GetAdvertisingSidResponse)(nil),              // 17: bluetooth_le.GetAdvertisingSidResponse
	(*GetDataStatusRequest)(nil),                   // 18: bluetooth_le.GetDataStatusRequest
	(*GetDataStatusResponse)(nil),                  // 19: bluetooth_le.GetDataStatusResponse
	(*GetDeviceRequest)(nil),                       // 20: bluetooth_le.GetDeviceRequest
	(*GetDeviceResponse)(nil),                      // 21: bluetooth_le.GetDeviceResponse
	(*GetPeriodicAdvertisingIntervalRequest)(nil),  // 22: bluetooth_le.GetPeriodicAdvertisingIntervalRequest
	(*GetPeriodicAdvertisingIntervalResponse)(nil), // 23: bluetooth_le.GetPeriodicAdvertisingIntervalResponse
	(*GetPrimaryPhyRequest)(nil),                   // 24: bluetooth_le.GetPrimaryPhyRequest
	(*GetPrimaryPhyResponse)(nil),                  // 25: bluetooth_le.GetPrimaryPhyResponse
	(*GetRssiRequest)(nil),                         // 26: bluetooth_le.GetRssiRequest
	(*GetRssiResponse)(nil),                        // 27: bluetooth_le.GetRssiResponse
	(*GetScanRecordRequest)(nil),                   // 28: bluetooth_le.GetScanRecordRequest
	(*GetScanRecordResponse)(nil),                  // 29: bluetooth_le.GetScanRecordResponse
	(*GetSecondaryPhyRequest)(nil),                 // 30: bluetooth_le.GetSecondaryPhyRequest
	(*GetSecondaryPhyResponse)(nil),                // 31: bluetooth_le.GetSecondaryPhyResponse
	(*GetTimestampNanosRequest)(nil),               // 32: bluetooth_le.GetTimestampNanosRequest
	(*GetTimestampNanosResponse)(nil),              // 33: bluetooth_le.GetTimestampNanosResponse
	(*GetTxPowerRequest)(nil),                      // 34: bluetooth_le.GetTxPowerRequest
	(*GetTxPowerResponse)(nil),                     // 35: bluetooth_le.GetTxPowerResponse
	(*HashCodeRequest)(nil),                        // 36: bluetooth_le.HashCodeRequest
	(*HashCodeResponse)(nil),                       // 37: bluetooth_le.HashCodeResponse
	(*IsConnectableRequest)(nil),                   // 38: bluetooth_le.IsConnectableRequest
	(*IsConnectableResponse)(nil),                  // 39: bluetooth_le.IsConnectableResponse
	(*IsLegacyRequest)(nil),                        // 40: bluetooth_le.IsLegacyRequest
	(*IsLegacyResponse)(nil),                       // 41: bluetooth_le.IsLegacyResponse
	(*ToStringRequest)(nil),                        // 42: bluetooth_le.ToStringRequest
	(*ToStringResponse)(nil),                       // 43: bluetooth_le.ToStringResponse
	(*WriteToParcelRequest)(nil),                   // 44: bluetooth_le.WriteToParcelRequest
	(*WriteToParcelResponse)(nil),                  // 45: bluetooth_le.WriteToParcelResponse
...
var file_proto_bluetooth_le_bluetooth_le_proto_depIdxs = []int32{
	...
	12, // 6: bluetooth_le.ScanResultService.DescribeContents:input_type -> bluetooth_le.DescribeContentsRequest
	14, // 7: bluetooth_le.ScanResultService.Equals:input_type -> bluetooth_le.EqualsRequest
	16, // 8: bluetooth_le.ScanResultService.GetAdvertisingSid:input_type -> bluetooth_le.GetAdvertisingSidRequest
	18, // 9: bluetooth_le.ScanResultService.GetDataStatus:input_type -> bluetooth_le.GetDataStatusRequest
	20, // 10: bluetooth_le.ScanResultService.GetDevice:input_type -> bluetooth_le.GetDeviceRequest
	22, // 11: bluetooth_le.ScanResultService.GetPeriodicAdvertisingInterval:input_type -> bluetooth_le.GetPeriodicAdvertisingIntervalRequest
	24, // 12: bluetooth_le.ScanResultService.GetPrimaryPhy:input_type -> bluetooth_le.GetPrimaryPhyRequest
	26, // 13: bluetooth_le.ScanResultService.GetRssi:input_type -> bluetooth_le.GetRssiRequest
	28, // 14: bluetooth_le.ScanResultService.GetScanRecord:input_type -> bluetooth_le.GetScanRecordRequest
	30, // 15: bluetooth_le.ScanResultService.GetSecondaryPhy:input_type -> bluetooth_le.GetSecondaryPhyRequest
	32, // 16: bluetooth_le.ScanResultService.GetTimestampNanos:input_type -> bluetooth_le.GetTimestampNanosRequest
	34, // 17: bluetooth_le.ScanResultService.GetTxPower:input_type -> bluetooth_le.GetTxPowerRequest
	36, // 18: bluetooth_le.ScanResultService.HashCode:input_type -> bluetooth_le.HashCodeRequest
	38, // 19: bluetooth_le.ScanResultService.IsConnectable:input_type -> bluetooth_le.IsConnectableRequest
	40, // 20: bluetooth_le.ScanResultService.IsLegacy:input_type -> bluetooth_le.IsLegacyRequest
	42, // 21: bluetooth_le.ScanResultService.ToString:input_type -> bluetooth_le.ToStringRequest
	44, // 22: bluetooth_le.ScanResultService.WriteToParcel:input_type -> bluetooth_le.WriteToParcelRequest
	...
	1,  // 29: bluetooth_le.BluetoothLeScannerService.FlushPendingScanResults:output_type -> bluetooth_le.FlushPendingScanResultsResponse
	3,  // 30: bluetooth_le.BluetoothLeScannerService.StartScan1:output_type -> bluetooth_le.StartScan1Response
	5,  // 31: bluetooth_le.BluetoothLeScannerService.StartScan3_1:output_type -> bluetooth_le.StartScan3_1Response
	7,  // 32: bluetooth_le.BluetoothLeScannerService.StartScan3_2:output_type -> bluetooth_le.StartScan3_2Response
	9,  // 33: bluetooth_le.BluetoothLeScannerService.StopScan1:output_type -> bluetooth_le.StopScan1Response
	11, // 34: bluetooth_le.BluetoothLeScannerService.StopScan1_1:output_type -> bluetooth_le.StopScan1_1Response
	13, // 35: bluetooth_le.ScanResultService.DescribeContents:output_type -> bluetooth_le.DescribeContentsResponse
	15, // 36: bluetooth_le.ScanResultService.Equals:output_type -> bluetooth_le.EqualsResponse
	17, // 37: bluetooth_le.ScanResultService.GetAdvertisingSid:output_type -> bluetooth_le.GetAdvertisingSidResponse
	19, // 38: bluetooth_le.ScanResultService.GetDataStatus:output_type -> bluetooth_le.GetDataStatusResponse
	21, // 39: bluetooth_le.ScanResultService.GetDevice:output_type -> bluetooth_le.GetDeviceResponse
	23, // 40: bluetooth_le.ScanResultService.GetPeriodicAdvertisingInterval:output_type -> bluetooth_le.GetPeriodicAdvertisingIntervalResponse
	25, // 41: bluetooth_le.ScanResultService.GetPrimaryPhy:output_type -> bluetooth_le.GetPrimaryPhyResponse
	27, // 42: bluetooth_le.ScanResultService.GetRssi:output_type -> bluetooth_le.GetRssiResponse
	29, // 43: bluetooth_le.ScanResultService.GetScanRecord:output_type -> bluetooth_le.GetScanRecordResponse
	31, // 44: bluetooth_le.ScanResultService.GetSecondaryPhy:output_type -> bluetooth_le.GetSecondaryPhyResponse
	33, // 45: bluetooth_le.ScanResultService.GetTimestampNanos:output_type -> bluetooth_le.GetTimestampNanosResponse
	35, // 46: bluetooth_le.ScanResultService.GetTxPower:output_type -> bluetooth_le.GetTxPowerResponse
	37, // 47: bluetooth_le.ScanResultService.HashCode:output_type -> bluetooth_le.HashCodeResponse
	39, // 48: bluetooth_le.ScanResultService.IsConnectable:output_type -> bluetooth_le.IsConnectableResponse
	41, // 49: bluetooth_le.ScanResultService.IsLegacy:output_type -> bluetooth_le.IsLegacyResponse
	43, // 50: bluetooth_le.ScanResultService.ToString:output_type -> bluetooth_le.ToStringResponse
	45, // 51: bluetooth_le.ScanResultService.WriteToParcel:output_type -> bluetooth_le.WriteToParcelResponse
