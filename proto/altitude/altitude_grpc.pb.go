...
const (
	ConverterService_NewConverter_FullMethodName                = "/altitude.ConverterService/NewConverter"
...
type ConverterServiceClient interface {
	NewConverter(ctx context.Context, in *NewConverterRequest, opts ...grpc.CallOption) (*NewConverterResponse, error)
...
func (c *converterServiceClient) NewConverter(ctx context.Context, in *NewConverterRequest, opts ...grpc.CallOption) (*NewConverterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewConverterResponse)
	err := c.cc.Invoke(ctx, ConverterService_NewConverter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConverterServiceServer interface {
	NewConverter(context.Context, *NewConverterRequest) (*NewConverterResponse, error)
...
func (UnimplementedConverterServiceServer) NewConverter(context.Context, *NewConverterRequest) (*NewConverterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NewConverter not implemented")
}
...
func _ConverterService_NewConverter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewConverterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConverterServiceServer).NewConverter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConverterService_NewConverter_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConverterServiceServer).NewConverter(ctx, req.(*NewConverterRequest))
	}
...
var ConverterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NewConverter",
			Handler:    _ConverterService_NewConverter_Handler,
		},
		{
