...
const file_proto_vpn_vpn_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\x03R\x06result2\xdc\x04\n" +
...
var file_proto_vpn_vpn_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_proto_vpn_vpn_proto_goTypes = []any{
	(*IsAlwaysOnRequest)(nil),             // 0: vpn.IsAlwaysOnRequest
	(*IsAlwaysOnResponse)(nil),            // 1: vpn.IsAlwaysOnResponse
	(*IsLockdownEnabledRequest)(nil),      // 2: vpn.IsLockdownEnabledRequest
	(*IsLockdownEnabledResponse)(nil),     // 3: vpn.IsLockdownEnabledResponse
	(*OnBindRequest)(nil),                 // 4: vpn.OnBindRequest
	(*OnBindResponse)(nil),                // 5: vpn.OnBindResponse
	(*OnRevokeRequest)(nil),               // 6: vpn.OnRevokeRequest
	(*OnRevokeResponse)(nil),              // 7: vpn.OnRevokeResponse
	(*Protect1Request)(nil),               // 8: vpn.Protect1Request
	(*Protect1Response)(nil),              // 9: vpn.Protect1Response
	(*Protect1_1Request)(nil),             // 10: vpn.Protect1_1Request
	(*Protect1_1Response)(nil),            // 11: vpn.Protect1_1Response
	(*Protect1_2Request)(nil),             // 12: vpn.Protect1_2Request
	(*Protect1_2Response)(nil),            // 13: vpn.Protect1_2Response
	(*SetUnderlyingNetworksRequest)(nil),  // 14: vpn.SetUnderlyingNetworksRequest
	(*SetUnderlyingNetworksResponse)(nil), // 15: vpn.SetUnderlyingNetworksResponse
	(*PrepareRequest)(nil),                // 16: vpn.PrepareRequest
	(*PrepareResponse)(nil),               // 17: vpn.PrepareResponse
}
var file_proto_vpn_vpn_proto_depIdxs = []int32{
	0,  // 0: vpn.ServiceService.IsAlwaysOn:input_type -> vpn.IsAlwaysOnRequest
	2,  // 1: vpn.ServiceService.IsLockdownEnabled:input_type -> vpn.IsLockdownEnabledRequest
	4,  // 2: vpn.ServiceService.OnBind:input_type -> vpn.OnBindRequest
	6,  // 3: vpn.ServiceService.OnRevoke:input_type -> vpn.OnRevokeRequest
	8,  // 4: vpn.ServiceService.Protect1:input_type -> vpn.Protect1Request
	10, // 5: vpn.ServiceService.Protect1_1:input_type -> vpn.Protect1_1Request
	12, // 6: vpn.ServiceService.Protect1_2:input_type -> vpn.Protect1_2Request
	14, // 7: vpn.ServiceService.SetUnderlyingNetworks:input_type -> vpn.SetUnderlyingNetworksRequest
	16, // 8: vpn.ServiceService.Prepare:input_type -> vpn.PrepareRequest
	1,  // 9: vpn.ServiceService.IsAlwaysOn:output_type -> vpn.IsAlwaysOnResponse
	3,  // 10: vpn.ServiceService.IsLockdownEnabled:output_type -> vpn.IsLockdownEnabledResponse
	5,  // 11: vpn.ServiceService.OnBind:output_type -> vpn.OnBindResponse
	7,  // 12: vpn.ServiceService.OnRevoke:output_type -> vpn.OnRevokeResponse
	9,  // 13: vpn.ServiceService.Protect1:output_type -> vpn.Protect1Response
	11, // 14: vpn.ServiceService.Protect1_1:output_type -> vpn.Protect1_1Response
	13, // 15: vpn.ServiceService.Protect1_2:output_type -> vpn.Protect1_2Response
	15, // 16: vpn.ServiceService.SetUnderlyingNetworks:output_type -> vpn.SetUnderlyingNetworksResponse
	17, // 17: vpn.ServiceService.Prepare:output_type -> vpn.PrepareResponse
