...
type managerOnThermalStatusChangedListenerServiceClient struct {
	cc grpc.ClientConnInterface
}
...
func NewManagerOnThermalStatusChangedListenerServiceClient(cc grpc.ClientConnInterface) ManagerOnThermalStatusChangedListenerServiceClient {
	return &managerOnThermalStatusChangedListenerServiceClient{cc}
}

func (c *managerOnThermalStatusChangedListenerServiceClient) OnThermalStatusChanged(ctx context.Context, in *OnThermalStatusChangedRequest, opts ...grpc.CallOption) (*OnThermalStatusChangedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OnThermalStatusChangedResponse)
	err := c.cc.Invoke(ctx, ManagerOnThermalStatusChangedListenerService_OnThermalStatusChanged_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ManagerOnThermalStatusChangedListenerServiceServer is the server API for ManagerOnThermalStatusChangedListenerService service.
// All implementations must embed UnimplementedManagerOnThermalStatusChangedListenerServiceServer
// for forward compatibility.
type ManagerOnThermalStatusChangedListenerServiceServer interface {
	...
	mustEmbedUnimplementedManagerOnThermalStatusChangedListenerServiceServer()
}

// UnimplementedManagerOnThermalStatusChangedListenerServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedManagerOnThermalStatusChangedListenerServiceServer) OnThermalStatusChanged(context.Context, *OnThermalStatusChangedRequest) (*OnThermalStatusChangedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OnThermalStatusChanged not implemented")
}
func (UnimplementedManagerOnThermalStatusChangedListenerServiceServer) mustEmbedUnimplementedManagerOnThermalStatusChangedListenerServiceServer() {
}
func (UnimplementedManagerOnThermalStatusChangedListenerServiceServer) testEmbeddedByValue() {}

// UnsafeManagerOnThermalStatusChangedListenerServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ManagerOnThermalStatusChangedListenerServiceServer will
// result in compilation errors.
...
func RegisterManagerOnThermalStatusChangedListenerServiceServer(s grpc.ServiceRegistrar, srv ManagerOnThermalStatusChangedListenerServiceServer) {
	// If the following call panics, it indicates UnimplementedManagerOnThermalStatusChangedListenerServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&ManagerOnThermalStatusChangedListenerService_ServiceDesc, srv)
}

func _ManagerOnThermalStatusChangedListenerService_OnThermalStatusChanged_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OnThermalStatusChangedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagerOnThermalStatusChangedListenerServiceServer).OnThermalStatusChanged(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ManagerOnThermalStatusChangedListenerService_OnThermalStatusChanged_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerOnThermalStatusChangedListenerServiceServer).OnThermalStatusChanged(ctx, req.(*OnThermalStatusChangedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// ManagerOnThermalStatusChangedListenerService_ServiceDesc is the grpc.ServiceDesc for ManagerOnThermalStatusChangedListenerService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
...
type managerWakeLockStateListenerServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewManagerWakeLockStateListenerServiceClient(cc grpc.ClientConnInterface) ManagerWakeLockStateListenerServiceClient {
	return &managerWakeLockStateListenerServiceClient{cc}
}

func (c *managerWakeLockStateListenerServiceClient) OnStateChanged(ctx context.Context, in *OnStateChangedRequest, opts ...grpc.CallOption) (*OnStateChangedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OnStateChangedResponse)
	err := c.cc.Invoke(ctx, ManagerWakeLockStateListenerService_OnStateChanged_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ManagerWakeLockStateListenerServiceServer is the server API for ManagerWakeLockStateListenerService service.
// All implementations must embed UnimplementedManagerWakeLockStateListenerServiceServer
// for forward compatibility.
type ManagerWakeLockStateListenerServiceServer interface {
	...
	mustEmbedUnimplementedManagerWakeLockStateListenerServiceServer()
}

// UnimplementedManagerWakeLockStateListenerServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedManagerWakeLockStateListenerServiceServer) OnStateChanged(context.Context, *OnStateChangedRequest) (*OnStateChangedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OnStateChanged not implemented")
}
func (UnimplementedManagerWakeLockStateListenerServiceServer) mustEmbedUnimplementedManagerWakeLockStateListenerServiceServer() {
}
func (UnimplementedManagerWakeLockStateListenerServiceServer) testEmbeddedByValue() {}

// UnsafeManagerWakeLockStateListenerServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ManagerWakeLockStateListenerServiceServer will
// result in compilation errors.
...
func RegisterManagerWakeLockStateListenerServiceServer(s grpc.ServiceRegistrar, srv ManagerWakeLockStateListenerServiceServer) {
	// If the following call panics, it indicates UnimplementedManagerWakeLockStateListenerServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&ManagerWakeLockStateListenerService_ServiceDesc, srv)
}

func _ManagerWakeLockStateListenerService_OnStateChanged_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OnStateChangedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagerWakeLockStateListenerServiceServer).OnStateChanged(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ManagerWakeLockStateListenerService_OnStateChanged_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerWakeLockStateListenerServiceServer).OnStateChanged(ctx, req.(*OnStateChangedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// ManagerWakeLockStateListenerService_ServiceDesc is the grpc.ServiceDesc for ManagerWakeLockStateListenerService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
