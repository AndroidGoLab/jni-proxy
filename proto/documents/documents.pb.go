...
func (x *DescribeContentsRequest) Reset() {
	*x = DescribeContentsRequest{}
	mi := &file_proto_documents_documents_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DescribeContentsRequest) Descriptor() ([]byte, []int) {
	return file_proto_documents_documents_proto_rawDescGZIP(), []int{58}
}
...
func (x *DescribeContentsResponse) Reset() {
	*x = DescribeContentsResponse{}
	mi := &file_proto_documents_documents_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DescribeContentsResponse) Descriptor() ([]byte, []int) {
	return file_proto_documents_documents_proto_rawDescGZIP(), []int{59}
}
...
func (x *EqualsRequest) Reset() {
	*x = EqualsRequest{}
	mi := &file_proto_documents_documents_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EqualsRequest) Descriptor() ([]byte, []int) {
	return file_proto_documents_documents_proto_rawDescGZIP(), []int{60}
}
...
func (x *EqualsResponse) Reset() {
	*x = EqualsResponse{}
	mi := &file_proto_documents_documents_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EqualsResponse) Descriptor() ([]byte, []int) {
	return file_proto_documents_documents_proto_rawDescGZIP(), []int{61}
}
...
func (x *ContractPathGetRootIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_proto_documents_documents_proto_rawDesc = "" +
	...
	"\x15WriteToParcelResponse2\xa1\x15\n" +
	...
	"\rWriteToParcel\x12\x1f.documents.WriteToParcelRequest\x1a .documents.WriteToParcelResponseB3Z1github.com/AndroidGoLab/jni-proxy/proto/documentsb\x06proto3"
...
var file_proto_documents_documents_proto_goTypes = []any{
	...
	(*DescribeContentsRequest)(nil),                 // 58: documents.DescribeContentsRequest
