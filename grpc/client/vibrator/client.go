...
func (c *FrequencyProfileClient) GetFrequenciesOutputAcceleration(ctx context.Context) (int64, error) {
	resp, err := c.svc.GetFrequenciesOutputAcceleration(ctx, &pb.GetFrequenciesOutputAccelerationRequest{})
	if err != nil {
		return 0, err
	}
	return resp.GetResult(), nil
...
func (c *FrequencyProfileClient) GetFrequencyRange(ctx context.Context, arg0 float32) (int64, error) {
	resp, err := c.svc.GetFrequencyRange(ctx, &pb.GetFrequencyRangeRequest{
		Arg0: arg0,
	})
	if err != nil {
		return 0, err
