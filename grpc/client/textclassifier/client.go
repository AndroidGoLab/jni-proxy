...
func (c *TextClassifierEntityConfigClient) GetHints(ctx context.Context) (int64, error) {
...
func (c *TextLinksClient) GetLinks(ctx context.Context) (int64, error) {
	resp, err := c.svc.GetLinks(ctx, &pb.GetLinksRequest{})
	if err != nil {
		return 0, err
	}
	return resp.GetResult(), nil
...
func (c *TextLinksTextLinkClient) GetConfidenceScore(ctx context.Context, arg0 string) (float32, error) {
	resp, err := c.svc.GetConfidenceScore(ctx, &pb.TextLinksTextLinkGetConfidenceScoreRequest{
		Arg0: arg0,
	})
	if err != nil {
		return 0, err
...
func (c *TextClassificationClient) GetConfidenceScore(ctx context.Context, arg0 string) (float32, error) {
	resp, err := c.svc.GetConfidenceScore(ctx, &pb.TextClassificationGetConfidenceScoreRequest{
		Arg0: arg0,
	})
	if err != nil {
		return 0, err
...
func (c *ConversationActionsClient) GetConversationActions(ctx context.Context, handle int64) (int64, error) {
	resp, err := c.svc.GetConversationActions(ctx, &pb.GetConversationActionsRequest{
		Handle: handle,
	})
	if err != nil {
		return 0, err
...
func (c *ConversationActionsRequestClient) GetConversation(ctx context.Context) (int64, error) {
	resp, err := c.svc.GetConversation(ctx, &pb.GetConversationRequest{})
	if err != nil {
		return 0, err
	}
	return resp.GetResult(), nil
...
// GetHints calls the GetHints RPC.
func (c *ConversationActionsRequestClient) GetHints(ctx context.Context) (int64, error) {
	resp, err := c.svc.GetHints(ctx, &pb.GetHintsRequest{})
	if err != nil {
		return 0, err
	}
...
func (c *TextSelectionClient) GetConfidenceScore(ctx context.Context, arg0 string) (float32, error) {
	resp, err := c.svc.GetConfidenceScore(ctx, &pb.TextSelectionGetConfidenceScoreRequest{
		Arg0: arg0,
	})
	if err != nil {
		return 0, err
